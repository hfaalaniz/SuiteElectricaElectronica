...
namespace BuckConverterCalculator.SchematicEditor
{
    ...
    public class SchematicEditorForm : Form
    {
        ...
        private void PopulateComponentLibrary()
        {
            ...
            //libraryListBox.Items.Add("🔺 OpAmp LM358");
            libraryListBox.Items.Add("⚡ Logic Gate AND");
            libraryListBox.Items.Add("⚡ Logic Gate OR");
            libraryListBox.Items.Add("⚡ Logic Gate NAND");
            libraryListBox.Items.Add("🔲 Flip-Flop D-Type");
            libraryListBox.Items.Add("🔲 Flip-Flop JK");
            libraryListBox.Items.Add("⚡ Inverter (NOT)");
            libraryListBox.Items.Add("🔢 7-Segment Display");
            libraryListBox.Items.Add("💡 Optocoupler 4N35");
            libraryListBox.Items.Add("⚡ TRIAC 8A");
            libraryListBox.Items.Add("⚡ Thyristor (SCR) 10A");
        }
        ...
        private SchematicComponent CreateComponentFromLibraryItem(string itemText)
        {
            ...
            else if (itemText.Contains("OpAmp LM358"))
            {
                component = new OpAmpComponent
                {
                    Name = document.GetNextComponentName(ComponentType.OpAmp),
            ...
            else if (itemText.Contains("Logic Gate AND"))
            {
                component = new LogicGateComponent
                {
                    Name = document.GetNextComponentName(ComponentType.LogicGate),
            ...
            else if (itemText.Contains("Logic Gate OR"))
            {
                component = new LogicGateComponent
                {
                    Name = document.GetNextComponentName(ComponentType.LogicGate),
            ...
            else if (itemText.Contains("Logic Gate NAND"))
            {
                component = new LogicGateComponent
                {
                    Name = document.GetNextComponentName(ComponentType.LogicGate),
            ...
            else if (itemText.Contains("Flip-Flop D-Type"))
            {
                component = new FlipFlopComponent
                {
                    Name = document.GetNextComponentName(ComponentType.FlipFlop),
            ...
            else if (itemText.Contains("Flip-Flop JK"))
            {
                component = new FlipFlopComponent
                {
                    Name = document.GetNextComponentName(ComponentType.FlipFlop),
            ...
            else if (itemText.Contains("Inverter"))
            {
                component = new InverterComponent
                {
                    Name = document.GetNextComponentName(ComponentType.Inverter),
            ...
            else if (itemText.Contains("7-Segment"))
            {
                component = new LED7SegmentComponent
                {
                    Name = document.GetNextComponentName(ComponentType.LED7Segment),
            ...
            else if (itemText.Contains("Optocoupler"))
            {
                component = new OptocouplerComponent
                {
                    Name = document.GetNextComponentName(ComponentType.Optocoupler),
            ...
            else if (itemText.Contains("TRIAC"))
            {
                component = new TriacComponent
                {
                    Name = document.GetNextComponentName(ComponentType.Triac),
            ...
            else if (itemText.Contains("Thyristor"))
            {
                component = new ThyristorComponent
                {
                    Name = document.GetNextComponentName(ComponentType.Thyristor),
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (currentMode == EditorMode.Select)
                {
                    ...
                    if (pinClicked.component != null && pinClicked.pin != null)
                    {
                        ...
                        statusLabel.Text = "Routing wire... Click to add waypoints, double-click to finish";
                        canvas.Invalidate();
                        return;
                    }
        ...
        private void Canvas_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                // Finalizar wire sin conectar a pin (terminar en el aire)
                Point canvasPoint = new Point(
                    (int)(e.X / zoomFactor),
                    (int)(e.Y / zoomFactor)
                );

                wirePoints.Add(canvasPoint);
                ...
                statusLabel.Text = "Wire created (unconnected end)";
                canvas.Invalidate();
            }
        }
        ...
        private void HandleWireClick(Point point)
        {
            ...
            statusLabel.Text = $"Wire waypoint added. Points: {wirePoints.Count}";
        }
        ...
        private void FinishWiring(ComponentPin endPin, SchematicComponent endComponent)
        {
            ...
            else if (wireRoutingMode == WireRoutingMode.Direct)
            {
                CreateDirectWire();
            }
